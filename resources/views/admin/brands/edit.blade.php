...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Hãng sản phẩm
                    <small>Sửa</small>
                </h1>
                <form action="{{ route('brand.edit',['id' => $brand['id']]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Nhập tên hãng" id="brand-name" name="brand-name" value="{{ $brand['name'] }}" required>
                    </div>
                    <div class="form-group">
